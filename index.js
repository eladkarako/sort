...
async function sort_and_unique_textarea(inline_sort_separator){
  ...
  if("string" === typeof inline_sort_separator){
    lines = lines.map(line=>(sort_and_unique_array_of_strings( line.split(inline_sort_separator) ).join(inline_sort_separator)));
  }
...
textarea.addEventListener("keyup",  key_handler , {capture:false, passive:false, once:false});
